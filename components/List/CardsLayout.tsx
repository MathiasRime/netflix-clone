...
import styles from '../../public/styles/Cards.module.scss';
import { Genre, Media } from '../../types/types';
...
export default function CardLayout({ index, item }: FeatureCardProps): React.ReactElement {
